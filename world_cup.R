...
font_add('fs', './fontawesome-free-6.2.1-desktop/otfs/Font Awesome 6 Free-Solid-900.otf')
sysfonts::font_add('fb', './fontawesome-free-6.2.1-desktop/otfs/Font Awesome 6 Free-Regular-400.otf')
...
#subset to specific year - 2018
matches<-wcmatches|>filter(year==2018)
...
title = paste0(
  "<span style='font-family:Roboto;font-size:17pt;'>**2018 FIFA World Cup | Group Stage** </span><br>",
...
#save plot
ggsave("fifa_2018_group.png", bg="white", height=7, width=7.5, units='in')
